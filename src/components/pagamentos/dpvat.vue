<template>
  <div id="pagamento-dpvat" class="form-group" v-if="!controls.loading">
    <!-- <h3>dpvat</h3> -->
    <!-- <p>{{state}}</p> -->
    <!-- <p>{{controls}}</p> -->
    <!-- <p>Pagamento: {{paymentInfo}} tamanho {{Object.keys(paymentInfo).length}}</p> -->
    ...
    <section id="dpvat-completo" class="row" v-if="!isBarCodePayment">
      <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid':$v.paymentInfo.taxPayer.$invalid}">
      ...
      <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid':$v.paymentInfo.federalId.$invalid}">
      ...
      <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid': $v.paymentInfo.paymentDate.$invalid}">
        <label for="paymentDate">{{text.label_paymentDate}}</label>
        <date-picker id="paymentDate" :lang="'pt-br'" :format="'DD/MM/YYYY'" :first-day-of-week="1" :disabled-days="disableWeekends" v-model.trim="$v.paymentInfo.paymentDate.$model"></date-picker>
      </div>
      <!-- <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid': $v.paymentInfo.dueDate.$invalid}">
        <label for="dueDate">{{text.label_dueDate}}</label>
        <datepicker id="dueDate" :language="controls.datepicker.ptBR" :format="'dd/MM/yyyy'" :clear-button="true" v-model="paymentInfo.dueDate"></datepicker>
      </div> -->
      <div class="form-input col-xs-12 col-sm-6 col-lg-4"  :class="{'form-invalid':$v.paymentInfo.year.$invalid}">
      ...
      <div class="form-input col-xs-12 col-sm-5 col-lg-4"  :class="{'form-invalid':$v.paymentInfo.renavam.$invalid}">
      ...
      <div class="form-input col-xs-12 col-sm-3 col-lg-4"  :class="{'form-invalid':$v.paymentInfo.state.$invalid}">
      ...
      <!-- <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid':$v.paymentInfo.cityCode.$invalid}">
        ...
        <select name="cityCode" id="cityCode" v-model="paymentInfo.cityCode" :disabled="paymentInfo.state == undefined">
          <option :value="undefined" disabled hidden>{{text.placeholder_cityCode}}</option>
          <option v-for="(city, index) in content.cities" :key="index" :value="city.id">{{city.cityName}}</option>
        </select>
      </div> -->
      <div class="form-input col-xs-12 col-sm-4" :class="{'form-invalid':$v.paymentInfo.plate.$invalid}">
      ...
      <!-- <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid':$v.paymentInfo.paymentOption.$invalid}">
        <label for="paymentOption">{{text.label_paymentOption}}</label>
        <select name="paymentOption" id="paymentOption" v-model="paymentInfo.paymentOption" disabled>
      ...
      <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid':$v.paymentInfo.baseValue.$invalid}">
      ...
      <div class="form-input col-xs-12 col-sm-6 col-lg-4" :class="{'form-invalid': $v.paymentInfo.value.$invalid}">
    ...
    <section id="dpvat-barCode" class="row" v-else>
      ...
      <div class="col-xs-12">
        <div class="row">
          ...
          <div class="col-xs-6 col-lg-2" :class="{'form-invalid': $v.paymentInfo.paymentDate.$invalid}">
            <label for="paymentDate">{{text.label_paymentDate}}</label>
            <date-picker id="paymentDate" :lang="'pt-br'" :format="'DD/MM/YYYY'" :first-day-of-week="1" :disabled-days="disableWeekends" v-mask="'##/##/####'" v-model.trim="$v.paymentInfo.paymentDate.$model"></date-picker>
          </div>
          <div class="col-xs-6 col-lg-2" :class="{'form-invalid': $v.paymentInfo.dueDate.$invalid}">
            <label for="dueDate">{{text.label_dueDate}}</label>
            <date-picker id="paymentDate" :lang="'pt-br'" :format="'DD/MM/YYYY'" :first-day-of-week="1" :disabled-days="disableWeekends" v-mask="'##/##/####'" v-model.trim="$v.paymentInfo.dueDate.$model"></date-picker>
          </div>
