  ...
  <div id="panelNovaTransacao">
    ...
    <component-panel-section v-if="$mq ==='mobile' || $mq === 'tablet'">
      <ul id="links" slot="content">
        <li><a v-on:click="navegacao('conteudo')"><span><img src="~assets/img/ico-nova-transacao.svg" alt="simulação"></span> {{text.nova_transacao}}</a></li>
      </ul>
    </component-panel-section>
...
#panelNovaTransacao {
  #profile {
    #profilePicture {
      background: rgba(3, 133, 219, 0.1)
        url("~assets/img/ico-nova-transacao.svg");
      background-size: 50%;
...
// import transacaoHistorico from "~/components/itemHistoricoTransacoes.vue";
...
export default {
  data() {
    return {
      text: {
        panelNovaTransacao_historico: "Histórico recente últimas transações",
  ...
  components: {
    ...
    // "component-historico-transacao": transacaoHistorico,
