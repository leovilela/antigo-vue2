  ...
  <div>
    ...
    <component-panel-section v-if="$mq ==='mobile' || $mq === 'tablet'">
      <ul id="links" slot="content">
        <li><a v-on:click="navegacao('conteudo')"><span><img src="~assets/img/ico-relatorios-pagamentos-pq.png" alt="noticias"></span> {{text.relatoriosPagamento}}</a></li>
      </ul>
    </component-panel-section>
...
#profile {
  #profilePicture {
    background: rgba(3, 133, 219, 0.1)
      url("~assets/img/ico-relatorios-pagamentos.svg");
    background-size: 50%;
...
export default {
  data() {
    return {
      text: {
        relatoriosPagamento: "Relatórios de Pagamento",
      },
    };
  },
