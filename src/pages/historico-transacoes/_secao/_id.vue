  ...
  <transition name="page">
    <div id="historicoTransacoes">
      <component-layout>
        ...
        <component-conteudo-interno slot="main" :contentTitle="pageTitle" :activeSection ="secaoAtiva">
...
import panelHistoricoTransacoes from "~/components/panelHistoricoTransacoes.vue";
import contentHistoricoTransacoes from "~/components/contentHistoricoTransacoes.vue";
...
export default {
  ...
  components: {
    ...
    "component-panel": panelHistoricoTransacoes,
    "component-content": contentHistoricoTransacoes,
