...
import contentPagamentos from "~/components/contentPagamentos.vue";
...
export default {
  ...
  components: {
    ...
    "component-content": contentPagamentos,
  ...
  // Remover bloco abaixo quando retornar pagamentos para producao
  asyncData({ redirect }) {
