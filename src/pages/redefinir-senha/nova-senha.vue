<template>
  <transition name="page">
    <div id="nova-senha" class="page-redefinir-senha" v-if="validGuide">
      <component-layout>
        ...
        <form-nova-senha slot="right-content"></form-nova-senha>
...
import formNovaSenha from "~/components/redefinirSenha/novaSenha.vue";
...
export default {
  ...
  mounted() {
    this.$warehouse.get("password_guide") ? this.validGuide = true : this.validGuide = false;
  },
};
</script>
