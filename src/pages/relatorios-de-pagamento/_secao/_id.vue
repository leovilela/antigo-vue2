  ...
  <transition name="page">
    <div id="relatoriosPagamento">
      <component-layout>
        ...
        <component-conteudo-interno slot="main" :contentTitle="pageTitle" :ppActiveSectionLocal ="secaoAtiva">
...
import panelRelatoriosPagamento from "~/components/panelRelatoriosPagamento.vue";
import contentRelatoriosPagamento from "~/components/contentRelatoriosPagamento.vue";
...
export default {
  ...
  components: {
    ...
    "component-panel": panelRelatoriosPagamento,
    "component-content": contentRelatoriosPagamento,
